...
<body background="<?php echo base_url('img/b4bfafa2dccc4cf3fe24f774b3f13b12.jpg') ?>">
	<div class="container">
		<nav class="navbar navbar-expand-lg navbar-light bg-primary">
			<a class="navbar-brand" href="<?php echo base_url(); ?>"><i class="far fa-address-book" ></i></a>
		...
		<div class="row">
			...
			<div class="col-sm-4" >
				<center>
					<img src="<?php echo base_url('img/images (9).jpeg') ?>" alt="" width="350" height="350">
				</center>
			</div>
			<div class="col-sm-6" style="background-color: #FFFFFF; border: 1px solid blue;">
				...
				<label for="concepto" class="form-control">Fragoso Núñez Sergio Giovanni</label>
				<label for="monto">Carrera:</label>
				<label for="concepto" class="form-control">Ingenieria en Sistemas Computacionales</label>
